...
Navo 开源，便于你检查它如何通过 TDLib 连接 Telegram、审计与隐私相关的行为，并在商店页面之外建立信任。本项目在开源上游基础上独立演进，不含第三方应用的专有资源。
...
Navo 基于 **[Mithka](https://github.com/iebb/mithka)**（作者 [iebb](https://github.com/iebb)）二次开发，感谢其提供的 Flutter + TDLib 开源基础（BSD-3-Clause）。Navo 作为独立项目继续演进，拥有自有品牌与平台支持。TDLib © Telegram，按其自身许可使用。本项目不包含任何第三方应用的专有资源或商标。
